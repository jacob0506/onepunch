...
const ASSETS_TO_CACHE = [
  ...
  './assets/data/bonds.json',
  './assets/data/counters.json',
  './assets/data/dailies.json',
  './assets/data/achievements.json',
  './assets/data/tutorial.json',
  './assets/data/config.json',
  './assets/data/awaken_profiles.json',
  './assets/data/expedition.json',
  './assets/data/challenge.json',
  './assets/data/squads.json',
  './assets/data/dispatch.json',
  './assets/data/arena.json',
  './assets/data/season.json',
  './assets/data/favor.json',
  './assets/data/stories.json',
  './assets/js/app/globals.js',
  './assets/js/app/dev.js',
  './assets/js/app/bridge.js',
  './assets/js/app/core/config.js?v=35',
  './assets/js/app/core/logger.js',
  './assets/js/app/core/format.js',
  './assets/js/app/core/names.js',
  './assets/js/app/core/storage.js',
  './assets/js/app/data/loader.js?v=38',
  './assets/js/app/ui/materials.js',
  './assets/js/app/ui/components.js?v=36',
  './assets/js/app/audio/engine.js?v=44',
  './assets/js/app/ui/idle.js?v=34',
  './assets/js/app/ui/navigation.js?v=44',
  './assets/js/app/ui/stages.js?v=41',
  './assets/js/app/ui/cultivate.js?v=37',
  './assets/js/app/ui/modals.js?v=35',
  './assets/js/app/ui/backpack.js?v=35',
  './assets/js/app/ui/item_picker.js',
  './assets/js/app/ui/inventory.js?v=35',
  './assets/js/app/ui/offline.js',
  './assets/js/app/ui/gacha.js?v=46',
  './assets/js/app/domain/character.js',
  './assets/js/app/domain/inventory.js',
  './assets/js/app/domain/progression.js',
  './assets/js/app/domain/idle.js?v=34',
  './assets/js/app/domain/goals.js?v=37',
  './assets/js/app/domain/reddot.js?v=38',
  './assets/js/app/domain/quick_ops.js?v=41',
  './assets/js/app/domain/bonds.js?v=38',
  './assets/js/app/domain/counters.js?v=41',
  './assets/js/app/domain/daily.js?v=38',
  './assets/js/app/domain/tower.js?v=34',
  './assets/js/app/domain/tutorial.js?v=34',
  './assets/js/app/domain/expedition.js?v=2',
  './assets/js/app/domain/challenge.js?v=1',
  './assets/js/app/domain/squads.js?v=1',
  './assets/js/app/domain/dispatch.js?v=1',
  './assets/js/app/domain/arena.js?v=1',
  './assets/js/app/domain/season.js?v=2',
  './assets/js/app/domain/season_trial.js?v=1',
  './assets/js/app/domain/favor.js?v=1',
  './assets/js/app/domain/stats.js?v=40',
  ...
  './assets/js/app/battle/rewards.js?v=34',
  './assets/js/app/battle/scene.js?v=49',
  // ── P5（2026-09-12）从 index.html 内联主脚本搬出的 9 个模块 ──
  './assets/js/app/data/bootstrap.js?v=46',
  './assets/js/app/data/characters.js?v=35',
  './assets/js/app/data/stage_expand.js?v=34',
  './assets/js/app/domain/character_ops.js?v=35',
  './assets/js/app/ui/home.js?v=35',
  './assets/js/app/ui/quick_ops.js?v=35',
  './assets/js/app/ui/reddot.js?v=36',
  './assets/js/app/ui/goals.js?v=36',
  './assets/js/app/ui/bonds.js?v=37',
  './assets/js/app/ui/daily.js?v=38',
  './assets/js/app/ui/codex.js?v=39',
  './assets/js/app/ui/character_view.js?v=35',
  './assets/js/app/ui/tutorial.js?v=34',
  './assets/js/app/ui/expedition.js?v=1',
  './assets/js/app/ui/challenge.js?v=3',
  './assets/js/app/ui/squads.js?v=1',
  './assets/js/app/ui/dispatch.js?v=1',
  './assets/js/app/ui/arena.js?v=1',
  ...
  './assets/vendor/tailwind/tailwind.js?v=34',
  './assets/vendor/font-awesome/css/font-awesome.min.css?v=34',
