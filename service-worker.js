const CACHE_NAME = 'card-game-v44';
const ASSETS_TO_CACHE = [
  ...
  './assets/js/app/ui/components.js?v=34',
  ...
  './assets/js/app/ui/gacha.js?v=44',
  ...
  './assets/js/app/domain/achievements.js?v=39',
  ...
  './assets/js/app/battle/scene.js?v=44',
  // ── P5（2026-09-12）从 index.html 内联主脚本搬出的 9 个模块 ──
  './assets/js/app/data/bootstrap.js?v=41',
  './assets/js/app/data/characters.js?v=34',
  './assets/js/app/data/stage_expand.js?v=34',
  './assets/js/app/domain/character_ops.js?v=34',
  './assets/js/app/ui/home.js?v=34',
  ...
  './assets/js/app/debug/cheats.js?v=34',
