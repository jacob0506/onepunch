const CACHE_NAME = 'card-game-v51';
const ASSETS_TO_CACHE = [
  ...
  './assets/js/app/data/loader.js?v=34',
  ...
  './assets/js/app/ui/stages.js?v=38',
  './assets/js/app/ui/cultivate.js?v=36',
  ...
  './assets/js/app/domain/goals.js?v=36',
  './assets/js/app/domain/reddot.js?v=36',
  './assets/js/app/domain/quick_ops.js?v=40',
  ...
  './assets/js/app/battle/scene.js?v=47',
  // ── P5（2026-09-12）从 index.html 内联主脚本搬出的 9 个模块 ──
  './assets/js/app/data/bootstrap.js?v=42',
  ...
  './assets/js/app/ui/character_view.js?v=34',
  './assets/js/app/ui/tutorial.js?v=34',
  './assets/js/app/battle/loadout_text.js?v=34',
  './assets/js/app/battle/fallback_hud.js?v=34',
